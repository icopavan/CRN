% Generates random locations and stores the location
% maxthrough_directional_deter can later run on this and 
...
for(i= 1:N_f)
    ...
    while(flag ==0)
        ...
        if(SINR_pu(i) >(SINRPU_lt+25))  % taking more than 100 to account for interference
            flag =1;
        end
    end
end
