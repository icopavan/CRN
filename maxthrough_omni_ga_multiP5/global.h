...
extern int angle1;
extern int angle2;
extern double multfactor;
extern double **pu;
extern double **su;
extern double *alpha;
extern double N,B,C,pwr_max,f,pwr_pu;
extern int N_f,M;
extern double **d_pu,**d_su,**d_supu;
extern double **L_pu,**L_supu;
extern double ***L_su;
extern double **alpha_su,**alpha_pu;
extern double G,G_M,G_S,theta;
extern double SINRSULT,SINRPULT;
